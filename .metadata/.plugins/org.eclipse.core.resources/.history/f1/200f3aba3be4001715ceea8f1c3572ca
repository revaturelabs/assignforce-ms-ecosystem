package com.revature.assignforceskillms.controller;

import com.revature.assignforceskillms.domain.Skill;
//import com.revature.assignforce.domain.dto.SkillDTO;
//import com.revature.assignforceskillms.domain.dto.ResponseErrorDTO;
import com.revature.assignforceskillms.service.ActivatableObjectDaoService;
