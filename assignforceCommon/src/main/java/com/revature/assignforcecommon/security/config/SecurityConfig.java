package com.revature.assignforcecommon.security.config;

import com.revature.assignforcecommon.security.filter.CustomOAuth2Filter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	AuthorizationCodeAccessTokenProvider noStateProvider = new AuthorizationCodeAccessTokenProvider();
	noStateProvider.setStateMandatory(false);
	salesforceTemplate.setAccessTokenProvider(noStateProvider);
