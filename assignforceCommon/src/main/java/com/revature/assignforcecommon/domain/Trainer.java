...
public class Trainer implements Activatable{
    ...
    /**
     * Gets the value of salesforceId
     *
     * @return the value of salesforceId
     */
    ...
    /**
     * Sets the value of salesforceId
     *
     * @param argSalesforceId Value to assign to this.salesforceId
     */
    public void setSalesforceId(String argSalesforceId) {
	this.salesforceId = argSalesforceId;
    }    
}
