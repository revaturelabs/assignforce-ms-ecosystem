package com.assignforce.locationservice.web;

import java.util.List;

import com.assignforce.locationservice.service.ActivatableObjectDaoService;
import com.assignforce.locationservice.service.LocationDaoService;
...
import com.assignforce.locationservice.domain.Building;
import com.assignforce.locationservice.domain.Location;
import com.assignforce.locationservice.domain.dto.ResponseErrorDTO;

@RestController
@RequestMapping("/api/v2/location")
@ComponentScan(basePackages = "com.assignforce.location.service")
...
//    @PreAuthorize("hasPermission('', 'manager')")
    ...
    public Object createLocation(@RequestBody Location in) {
...
//        int ID = in.getID();
        ...
        Location out = new Location(name, city, state, buildings, true);
...
//    @PreAuthorize("hasPermission('', 'manager')")
    ...
    public Object updateLocation(@RequestBody Location in) {
...
//        Location out = new Location(ID, name, city, state, buildings, active);
        Location out = locationService.saveItem(in);
...
//    @PreAuthorize("hasPermission('', 'manager')")
    ...
    public Object deleteLocation(@RequestBody Location in) {

        ((LocationDaoService) locationService).deleteLocationByID(in.getID());
        return new ResponseEntity<Object>(null, HttpStatus.OK);
    }
